...
//    Personaje jugador1;
//    Personaje jugador2;
//    public ArrayList<Hechizo> hechizosListP1 = new ArrayList<Hechizo>();
//    public ArrayList<Hechizo> hechizosListP2 = new ArrayList<Hechizo>();
//
//    public void seleccionPersonaje(Scanner keyboard) {
//        System.out.println("Hola Jugador 1. \n Que tipo de personaje desea: \n\t 1. Mago \n\t 2. Elfo");
//        int opt = keyboard.nextInt();
//        if (opt == 1) {
//            jugador1 = new Mago();
//            crearMago((Mago) jugador1, keyboard);
//            jugador1.setLocation(seleccionarUbicacion(keyboard));
//            seleccionarHechizos(hechizosListP1, keyboard);
//            int oscuro = 0;
//            for (ar.com.ada.online.second.HarryPotter.SuperClass.Hechizo hechizo : hechizosListP1) {
//                if (hechizo.getType()==1){
//                    oscuro++;
//                }
//            }
//            if (oscuro >= 3){
//                ((Mago) jugador1).setTipoDeMago(1);
//            }else {
//                ((Mago) jugador1).setTipoDeMago(2);
//            }
//
//
//        } else if (opt == 2) {
...
//            seleccionarHechizos(hechizosListP1, keyboard);
//            int oscuro = 0;
//            for (Hechizo hechizo : hechizosListP1) {
//                if (hechizo()==1){
//                    oscuro++;
//                }
//            }
//            if (oscuro >= 3){
//                jugador1.setTipoElfo(1);
//            }else {
//                ((Mago) jugador1).setTipoDeMago(2);
//            }
//
...
//        if (opt1 == 1) {
//            jugador2 = new Mago();
//            crearMago((Mago) jugador2, keyboard);
//            jugador2.setLocation(seleccionarUbicacion(keyboard));
//            seleccionarHechizos(hechizosListP2, keyboard);
//
//            int oscuro = 0;
//            for (ar.com.ada.online.second.HarryPotter.SuperClass.hechizo hechizo : hechizosListP2) {
//                if (hechizo.getType()==1){
//                    oscuro++;
//                }
//            }
//            if (oscuro >= 3){
//                ((Mago) jugador2).setTipoDeMago(1);
//            }else {
//                ((Mago) jugador2).setTipoDeMago(2);
//            }
//        }
//        if (opt1 == 2) {
//            jugador2 = new Elfo();
...
//            System.out.println("Tipo de personaje no vailido");
//        }
//        Partida.setPlayer1(jugador1);
//        Partida.setPlayer2(jugador2);
//        Partida.setHechizosListP1 (hechizosListP1);
//        Partida.setHechizosListP2 (hechizosListP2);
//    }
//
//
